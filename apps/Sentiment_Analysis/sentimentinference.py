    ...
    if option == 'Realtime Tweets':
        ...
        if st.button("Get Realtime Sentiment"):
            ...
            layout = go.Layout(
                ...
                font=dict( family="Courier New, monospace", size=24, color="White"))
        ...
        for i in range(1, 13):
            try:
                ...
                break
        x= list(month[j] for j in range(1, i))
        ...
        fig.update_layout( title="Negative Sentiment for given terms in 2021 with Months",
