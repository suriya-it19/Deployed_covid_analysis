...
def predict(image_path, thick):
    dect = Detector(image_path, thick)
    preds = dect.predict_()
...
def detect():
    ...
    if file_up is not None:
        ...
        image, score, label = predict("apps/Classification_modelling/CT_Image_Detector/images/image.jpg", thick)
